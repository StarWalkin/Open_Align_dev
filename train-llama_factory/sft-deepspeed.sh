...
output_dir="/cpfs01/shared/GAIR/GAIR_hdd/yguo/ckpts"
# BASE_MODEL=${ckpts_dir}/Qwen/Qwen-7B/
BASE_MODEL=/cpfs01/shared/GAIR/GAIR_hdd/yguo/ckpts/Qwen/Qwen1.5-7B
OUTPUT_DIR=${output_dir}/qwen1.5-7b-tulu2-math-code-enhanced
NUM_GPUS=8
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port=9701 src/train_bash.py \
    --deepspeed ds_config.json \
    --stage sft \
    --do_train True\
    --model_name_or_path ${BASE_MODEL} \
    --dataset tulu2_math_code_alignment_enhanced \
    --template qwen \
    --cutoff_len 8192 \
