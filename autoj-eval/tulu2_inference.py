...
def generate_choice(input_data):
     ...
     input_pairwise = build_autoj_input(prompt = input_data["prompt"],
                                       resp1 = input_data["response 1"],
                                       resp2 = input_data["response 2"],
...
if __name__ == '__main__':
    ...
    model_name_or_dir = "/cpfs01/shared/GAIR/GAIR_hdd/yguo/ckpts/qwen1.5-7b-tulu2"  # or "local path to auto-j"
    ...
    write_jsonl(res_list, "./en_pairwise_outputs_tulu2.jsonl", "a")
